...
#Voy a probar de ajustar los hiperparametros de lightgbm
...
hs <- makeParamSet(
  ...
  #lambda_l1 = 0.1, # variar de 0.001 a 0.1
  makeNumericParam("lambda_l1", lower = 0.1, upper = 0.1),
  #lambda_l2 = 0.1, # variar de 0.001 a 0.1
  makeNumericParam("lambda_l2", lower = 0.1, upper = 0.1)
)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    seed = ksemilla_azar1,
    boosting = "dart"  # Cambiar de 'gbdt' a 'dart'
  )
