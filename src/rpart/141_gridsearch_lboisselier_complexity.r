...
archivo_salida <- "./exp/HT2020/gridsearch_complexity.txt"
...
#ahora quiero explorar si hay diferencia con un cp bien amplio
for (vcp in seq(-5, 5, by = 0.1)) {
  for (vmin_split in c(400, 450, 500)) {
    for (vmin_bucket in c(10, 20, 30, 40)) {
