...
archivo_salida <- "./exp/HT2020/gridsearch_cp_negativo_repetido.txt"
...
rangos_cp <- seq(-0.1, 0.9, by = 0.05)
rangos_min_split <- c(100)
rangos_min_bucket <- c(10)
rangos_max_depth <- c(9)
