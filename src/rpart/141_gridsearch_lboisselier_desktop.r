...
for (vcp in seq(-10, 10, by = 0.5)) {
  for (vmin_split in c(150, 200, 250, 500, 750, 1000, 1500, 2000, 2500, 3000, 4000, 5000, 6000)) {
    for (vmin_bucket in c(5, 10, 20, 40, 50, 60, 70, 80, 90)) {
      if (vmin_split >= 2 * vmin_bucket) { 
        for (vmax_depth in c(3, 5, 6, 7, 8, 9, 10, 15)) {
          param_basicos <- list(
            cp = vcp,
            minsplit = vmin_split,
