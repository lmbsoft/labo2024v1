...
archivo_salida <- "./exp/HT2020/gridsearch_mejorado.txt"
...
for (vcp in seq(-0.15, -0.1, by = 0.1)) {
  for (vmin_split in c(700, 750, 800, 850, 900, 950, 1000, 1050, 1100 )) {
    for (vmin_bucket in c(20, 21, 22, 23, 24, 25)) {
