...
#reproducir es repetir con mis semillas
#replicar es repetir con las semillas de otro

PARAM$semillas <- c(127291, 288679, 564521, 731731, 859433)
#semillas de Elizabeth 127291, 288679, 564521, 731731, 859433
...
archivo_salida <- "./exp/HT2020/gridsearch_mejorado_elizabeth_replica.txt"
...
rangos_cp <- c(-0.5)
rangos_min_split <- c(600)
rangos_min_bucket <- c(150)
rangos_max_depth <- c(6)
