...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01a", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01a", "DT0001-01a" )

  DR_drifting_guantesblancos( "DR0001-01a", "CA0001-01a" )
  FE_historia_guantesblancos( "FE0001-01a", "DR0001-01a" )

  TS_strategy_guantesblancos_202109( "TS0001-01a", "FE0001-01a" )

  HT_tuning_guantesblancos( "HT0001-01a", "TS0001-01a" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01a", c("HT0001-01a","TS0001-01a") )
...
# por favor notal como este script parte de FE0001-01a

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01a y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01a", "FE0001-01a" )

  HT_tuning_guantesblancos( "HT0002-01a", "TS0002-01a" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01a", c("HT0002-01a", "TS0002-01a") )
...
# DT0001-01a, CA0001-01a, DR0001-01a, FE0001-01a, TS0001-01a, HT0001-01a y ZZ0001-01a
corrida_guantesblancos_202109( "0427-bo-completo-01a" )


# Luego partiendo de  FE0001-01a
# genero TS0002-01a, HT0002-01a y ZZ0002-01a

corrida_guantesblancos_202107( "0427-bo-completo-02a" )
