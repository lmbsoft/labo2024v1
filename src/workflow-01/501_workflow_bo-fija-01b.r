...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01b", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01b", "DT0001-01b" )

  DR_drifting_guantesblancos( "DR0001-01b", "CA0001-01b" )
  FE_historia_guantesblancos( "FE0001-01b", "DR0001-01b" )

  TS_strategy_guantesblancos_202109( "TS0001-01b", "FE0001-01b" )

  HT_tuning_guantesblancos( "HT0001-01b", "TS0001-01b" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01b", c("HT0001-01b","TS0001-01b") )
...
# por favor notal como este script parte de FE0001-01b

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01b y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01b", "FE0001-01b" )

  HT_tuning_guantesblancos( "HT0002-01b", "TS0002-01b" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01b", c("HT0002-01b", "TS0002-01b") )
...
# DT0001-01b, CA0001-01b, DR0001-01b, FE0001-01b, TS0001-01b, HT0001-01b y ZZ0001-01b
corrida_guantesblancos_202109( "0427-bo-fija-01b" )


# Luego partiendo de  FE0001-01b
# genero TS0002-01b, HT0002-01b y ZZ0002-01b

corrida_guantesblancos_202107( "0427-bo-fija-02b" )
