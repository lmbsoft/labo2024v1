...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01bz", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01bz", "DT0001-01bz" )

  DR_drifting_guantesblancos( "DR0001-01bz", "CA0001-01bz" )
  FE_historia_guantesblancos( "FE0001-01bz", "DR0001-01bz" )

  TS_strategy_guantesblancos_202109( "TS0001-01bz", "FE0001-01bz" )

  HT_tuning_guantesblancos( "HT0001-01bz", "TS0001-01bz" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01bz", c("HT0001-01bz","TS0001-01bz") )
...
# por favor notal como este script parte de FE0001-01bz

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01bz y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01bz", "FE0001-01bz" )

  HT_tuning_guantesblancos( "HT0002-01bz", "TS0002-01bz" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01bz", c("HT0002-01bz", "TS0002-01bz") )
...
# DT0001-01bz, CA0001-01bz, DR0001-01bz, FE0001-01bz, TS0001-01bz, HT0001-01bz y ZZ0001-01bz
corrida_guantesblancos_202109( "0427-bo-fija-01bz" )


# Luego partiendo de  FE0001-01bz
# genero TS0002-01bz, HT0002-01bz y ZZ0002-01bz

corrida_guantesblancos_202107( "0427-bo-fija-02bz" )
