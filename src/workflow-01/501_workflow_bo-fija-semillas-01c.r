...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$qsemillas <- 50 #pruebo con 50 semillas y nico con 25
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01c", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01c", "DT0001-01c" )

  DR_drifting_guantesblancos( "DR0001-01c", "CA0001-01c" )
  FE_historia_guantesblancos( "FE0001-01c", "DR0001-01c" )

  TS_strategy_guantesblancos_202109( "TS0001-01c", "FE0001-01c" )

  HT_tuning_guantesblancos( "HT0001-01c", "TS0001-01c" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01c", c("HT0001-01c","TS0001-01c") )
...
# por favor notal como este script parte de FE0001-01c

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01c y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01c", "FE0001-01c" )

  HT_tuning_guantesblancos( "HT0002-01c", "TS0002-01c" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01c", c("HT0002-01c", "TS0002-01c") )
...
# DT0001-01c, CA0001-01c, DR0001-01c, FE0001-01c, TS0001-01c, HT0001-01c y ZZ0001-01c
corrida_guantesblancos_202109( "0427-bo-fija-semillas-01c" )


# Luego partiendo de  FE0001-01c
# genero TS0002-01c, HT0002-01c y ZZ0002-01c

corrida_guantesblancos_202107( "0427-bo-fija-semillas-02c" )
