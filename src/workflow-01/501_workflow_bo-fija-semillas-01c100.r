...
# pmyexp <- "DR0001-01c100"
# pinputexps <- "CA0001-01c100"
# pserver <- "local"
...
# pmyexp <- "FE0001-01c100"
# pinputexps <- "DR0001-01c100"
# pserver <- "local"
...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$qsemillas <- 100 #pruebo con 100 semillas y nico con 25
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01c100", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01c100", "DT0001-01c100" )

  DR_drifting_guantesblancos( "DR0001-01c100", "CA0001-01c100" )
  FE_historia_guantesblancos( "FE0001-01c100", "DR0001-01c100" )

  TS_strategy_guantesblancos_202109( "TS0001-01c100", "FE0001-01c100" )

  HT_tuning_guantesblancos( "HT0001-01c100", "TS0001-01c100" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01c100", c("HT0001-01c100","TS0001-01c100") )
...
# por favor notal como este script parte de FE0001-01c100

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01c100 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01c100", "FE0001-01c100" )

  HT_tuning_guantesblancos( "HT0002-01c100", "TS0002-01c100" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01c100", c("HT0002-01c100", "TS0002-01c100") )
...
# DT0001-01c100, CA0001-01c100, DR0001-01c100, FE0001-01c100, TS0001-01c100, HT0001-01c100 y ZZ0001-01c100
corrida_guantesblancos_202109( "0428-bo-fija-semillas-01c100" )


# Luego partiendo de  FE0001-01c100
# genero TS0002-01c100, HT0002-01c100 y ZZ0002-01c100

corrida_guantesblancos_202107( "0428-bo-fija-semillas-02c100" )
