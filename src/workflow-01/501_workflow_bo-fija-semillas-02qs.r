...
# pmyexp <- "DR0001-01qs150"
# pinputexps <- "CA0001-01qs150"
# pserver <- "local"
...
# pmyexp <- "FE0001-01qs150"
# pinputexps <- "DR0001-01qs150"
# pserver <- "local"
...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local", qsemillas=15)
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01qs150", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01qs150", "DT0001-01qs150" )

  DR_drifting_guantesblancos( "DR0001-01qs150", "CA0001-01qs150" )
  FE_historia_guantesblancos( "FE0001-01qs150", "DR0001-01qs150" )

  TS_strategy_guantesblancos_202109( "TS0001-01qs150", "FE0001-01qs150" )

  HT_tuning_guantesblancos( "HT0001-01qs150", "TS0001-01qs150" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01qs150", c("HT0001-01qs150","TS0001-01qs150") , qsemillas=150)
...
corrida_guantesblancos_202109_ii <- function( pnombrewf, pvirgen=FALSE, qsemillas=5 )
{
  ...
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0001-01qs",qsemillas), c("HT0001-01qs150","TS0001-01qs150"), qsemillas=qsemillas )
...
# por favor notal como este script parte de FE0001-01qs150

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01qs150 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01qs150", "FE0001-01qs150" )

  HT_tuning_guantesblancos( "HT0002-01qs150", "TS0002-01qs150" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01qs150", c("HT0002-01qs150", "TS0002-01qs150") )
...
corrida_guantesblancos_202107_ii <- function( pnombrewf, pvirgen=FALSE, qsemillas=5 )
{
  ...
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0002-01qs",qsemillas), c("HT0002-01qs150", "TS0002-01qs150"), qsemillas=qsemillas )
...
# DT0001-01qs150, CA0001-01qs150, DR0001-01qs150, FE0001-01qs150, TS0001-01qs150, HT0001-01qs150 y ZZ0001-01qs150
corrida_guantesblancos_202109( "0429-bo-fija-semillas-01qs150" )


# Luego partiendo de  FE0001-01qs150
# genero TS0002-01qs150, HT0002-01qs150 y ZZ0002-01qs150

corrida_guantesblancos_202107( "0429-bo-fija-semillas-02qs150" )

#a partir de éste punto reutilizo las salidas de los workflows anteriores y corro el ZZ con 200 semillas o más. Luego ver la idea de no recalcular para semillas previas, por ahora queda así
corrida_guantesblancos_202109_ii( "0429-bo-fija-semillas-01qs200", qsemillas=200 )
corrida_guantesblancos_202107_ii( "0429-bo-fija-semillas-02qs200", qsemillas=200 )

corrida_guantesblancos_202109_ii( "0429-bo-fija-semillas-01qs250", qsemillas=250 )
corrida_guantesblancos_202107_ii( "0429-bo-fija-semillas-02qs250", qsemillas=250 )
