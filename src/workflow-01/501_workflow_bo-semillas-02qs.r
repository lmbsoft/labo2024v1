...
# pmyexp <- "DR0001-01boqs50"
# pinputexps <- "CA0001-01boqs50"
# pserver <- "local"
...
# pmyexp <- "FE0001-01boqs50"
# pinputexps <- "DR0001-01boqs50"
# pserver <- "local"
...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)


  param_local$train$training <- c(202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local", qsemillas=50)
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
  ...
  # Una corrida de Guantes Blancos solo usa n semillas
  param_local$qsemillas <- qsemillas # cantidad de semillas
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-01boqs50", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-01boqs50", "DT0001-01boqs50" )

  DR_drifting_guantesblancos( "DR0001-01boqs50", "CA0001-01boqs50" )
  FE_historia_guantesblancos( "FE0001-01boqs50", "DR0001-01boqs50" )

  TS_strategy_guantesblancos_202109( "TS0001-01boqs50", "FE0001-01boqs50" )

  HT_tuning_guantesblancos( "HT0001-01boqs50", "TS0001-01boqs50" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-01boqs50", c("HT0001-01boqs50","TS0001-01boqs50") , qsemillas=150)


  exp_wf_end( pnombrewf, pvirgen ) # linea fija
}

corrida_guantesblancos_202109_ii <- function( pnombrewf, pvirgen=FALSE, qsemillas=5 )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  ...
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0001-01boqs",qsemillas), c("HT0001-01boqs50","TS0001-01boqs50"), qsemillas=qsemillas )
...
# por favor notal como este script parte de FE0001-01boqs50

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001-01boqs50 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002-01boqs50", "FE0001-01boqs50" )

  HT_tuning_guantesblancos( "HT0002-01boqs50", "TS0002-01boqs50" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-01boqs50", c("HT0002-01boqs50", "TS0002-01boqs50") )


  exp_wf_end( pnombrewf, pvirgen ) # linea fija
}

corrida_guantesblancos_202107_ii <- function( pnombrewf, pvirgen=FALSE, qsemillas=5 )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija
  ...
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0002-01boqs",qsemillas), c("HT0002-01boqs50", "TS0002-01boqs50"), qsemillas=qsemillas )
...
# DT0001-01boqs50, CA0001-01boqs50, DR0001-01boqs50, FE0001-01boqs50, TS0001-01boqs50, HT0001-01boqs50 y ZZ0001-01boqs50
corrida_guantesblancos_202109( "0429-bo-semillas-01boqs50" )


# Luego partiendo de  FE0001-01boqs50
# genero TS0002-01boqs50, HT0002-01boqs50 y ZZ0002-01boqs50

corrida_guantesblancos_202107( "0429-bo-semillas-02boqs50" )

#a partir de éste punto reutilizo las salidas de los workflows anteriores y corro el ZZ con 100 semillas o más. Luego ver la idea de no recalcular para semillas previas, por ahora queda así
corrida_guantesblancos_202109_ii( "0429-bo-semillas-01boqs100", qsemillas=100 )
corrida_guantesblancos_202107_ii( "0429-bo-semillas-02boqs100", qsemillas=100 )

corrida_guantesblancos_202109_ii( "0429-bo-semillas-01boqs150", qsemillas=150 )
corrida_guantesblancos_202107_ii( "0429-bo-semillas-02boqs150", qsemillas=150 )

corrida_guantesblancos_202109_ii( "0429-bo-semillas-01boqs200", qsemillas=200 )
corrida_guantesblancos_202107_ii( "0429-bo-semillas-02boqs200", qsemillas=200 )

corrida_guantesblancos_202109_ii( "0429-bo-semillas-01boqs250", qsemillas=250 )
corrida_guantesblancos_202107_ii( "0429-bo-semillas-02boqs250", qsemillas=250 )
