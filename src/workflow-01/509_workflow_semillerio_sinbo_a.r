...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = 1,
    feature_fraction = c( 0.2, 0.201 ),
    num_leaves = c( 3L, 4L,  "integer" ),
    min_data_in_leaf = c( 50L, 51L, "integer" )
  )
...
#
  ...
  HT_tuning_baseline( "HT0001-sem-01a", "TS0001-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem-01a", c("HT0001-sem-01a","TS0001-sem") )
...
#
  ...
  HT_tuning_baseline( "HT0002-sem-02a", "TS0002-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem-02a", c("HT0002-sem-02a","TS0002-sem") )
...
corrida_baseline_semillerio_202109( "basem01-a" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem02-a" )
