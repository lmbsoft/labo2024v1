...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    learning_rate = 1,
    feature_fraction = c( 0.9, 0.901 ),
    num_leaves = c( 5000L, 5001L,  "integer" ),
    min_data_in_leaf = c( 3000L, 3000L, "integer" )
  )
...
#
  ...
  HT_tuning_baseline( "HT0001-sem-01b", "TS0001-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem-01b", c("HT0001-sem-01b","TS0001-sem") )
...
#
  ...
  HT_tuning_baseline( "HT0002-sem-02b", "TS0002-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem-02b", c("HT0002-sem-02b","TS0002-sem") )
...
corrida_baseline_semillerio_202109( "basem01-b" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem02-b" )
