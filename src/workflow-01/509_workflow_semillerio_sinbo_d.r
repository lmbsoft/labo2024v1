...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    #hiperparámetros de prueba de la mejor bayesiana
    learning_rate = 0.01,
    feature_fraction = c( 0.8, 0.801 ),
    num_leaves = c( 387L, 388L,  "integer" ),
    min_data_in_leaf = c( 1812L, 1813L, "integer" )
  )
...
#
  ...
  ZZ_final_semillerio_baseline( "ZZ0001-sem-01d2", c("HT0001-sem-01d","TS0001-sem") )
...
#
  ...
  HT_tuning_baseline( "HT0002-sem-02d", "TS0002-sem" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem-02d", c("HT0002-sem-02d","TS0002-sem") )
...
corrida_baseline_semillerio_202109( "basem01-d" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem02-d" )
