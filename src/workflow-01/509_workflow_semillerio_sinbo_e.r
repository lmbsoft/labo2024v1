...
#
  ...
  ZZ_final_semillerio_baseline( "ZZ0001-sem-01e", c("HT0001-sem-01e","TS0001-sem") )
...
#
  ...
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem-02e", c("HT0002-sem-02e","TS0002-sem") )
...
corrida_baseline_semillerio_202109( "basem01-e" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem02-e" )
